...
const Footer = () => {
    return (
        <>
            <footer className="footer p-10 bg-slate-800   text-white "  style={{backgroundImage: `url(${waterBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundBlendMode: 'overlay'}}>
                <div>
            ...
            <footer className="footer footer-center p-4 bg-slate-800  text-white" style={{backgroundImage: `url(${waterBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundBlendMode: 'overlay'}}>
                <div>
